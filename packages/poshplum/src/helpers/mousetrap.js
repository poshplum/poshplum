 ...
 *
 * Redistributed by Posh Plum,  based on a patch contributed to the
 * original project for adding the destroy() method, which removes event
 * listeners.
 * Removes IIFE in favor of a simple ESM export
 */
